...
public class TempDetailForm {
    ...
    public TempDetailForm(int tNumber, int abNumber, int mNumber, Date tempDate, int tempPeriod, String residence, String maritalStatus, String job, String status, String animalName, String memberName, String memberId) {
        this.tNumber = tNumber;
        this.abNumber = abNumber;
        this.mNumber = mNumber;

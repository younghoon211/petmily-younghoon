...
<%--        검색--%>
        ...
        <div class="col">
            <select name="species" class="form-control">
                <c:forEach var="animal" items="${['allSpecies', '개', '고양이', '기타']}">
                    <option value="${animal}" <c:if test="${species eq animal}">selected</c:if>>
        ...
        <div class="col">
            <select name="gender" class="form-control">
                <option value="allGender" <c:if test="${gender eq 'allGender'}">selected</c:if>>모든 성별
                </option>
                <option value="-" <c:if test="${gender eq '-'}">selected</c:if>>모름</option>
                <option value="M" <c:if test="${gender eq 'M'}">selected</c:if>>수컷</option>
                <option value="F" <c:if test="${gender eq 'F'}">selected</c:if>>암컷</option>
            </select>
        </div>
        ...
        <div class="col">
            <select name="animalState" class="form-control">
                <option value="allAnimalState"
                        <c:if test="${animalState eq 'allAnimalState'}">selected</c:if>>모든 상태
                </option>
                <option value="보호" <c:if test="${animalState eq '보호'}">selected</c:if>>보호중</option>
                <option value="임보" <c:if test="${animalState eq '임보'}">selected</c:if>>임시보호중</option>
            </select>
        </div>

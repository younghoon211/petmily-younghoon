...
<br>
    <form action="/admin/temp/write" method="post">
        ...
        <div class="form-group">
            <label>임시보호 기간 <span style="color: red"><small>&nbsp;※ 회원들에게는 임시보호 최소기간 10일로 명시함</small></span></label>
            <input type="text" name="tempPeriod" class="form-control" placeholder="일수를 입력해주세요." required>
        </div>
        ...
        <div class="form-group">
            <label>직업</label>
            <input type="text" name="job" class="form-control" placeholder="직업을 입력해주세요." required>
        </div>

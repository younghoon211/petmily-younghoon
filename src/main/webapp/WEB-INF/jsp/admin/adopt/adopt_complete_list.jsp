...
<section class="ftco-section bg-light">
    <div class="container" style="max-width: 1600px;">
        ...
        <div style="display: flex; justify-content: center;">
            <form action="/admin/adopt/complete" method="get">
                ...
                <div class="block-27">
                    <ul>
                        ...
                        <c:if test="${not empty param.keyword}">
                            <li>
                                <c:if test="${pageForm.startPage > 5}">
                                    <a href="/admin/adopt/complete?keyword=${param.keyword}&pageNo=${pageForm.startPage - 5}">&lt;</a>
                                </c:if>
                            </li>
                            <li>
                            <c:forEach var="pageNo" begin="${pageForm.startPage}" end="${pageForm.endPage}">
                                <c:if test="${pageForm.currentPage eq pageNo}">
                                    <li class="active">
                                        <a href="/admin/adopt/complete?keyword=${param.keyword}&pageNo=${pageNo}">${pageNo}</a>
                                    </li>
                                </c:if>
                        ...
                        <c:if test="${empty param.keyword}">
                            <li>
                                <c:if test="${pageForm.startPage > 5}">
                                    <a href="/admin/adopt/complete?pageNo=${pageForm.startPage - 5}">&lt;</a>
                                </c:if>
                            </li>
                            <li>
                            <c:forEach var="pageNo" begin="${pageForm.startPage}" end="${pageForm.endPage}">
                                <c:if test="${pageForm.currentPage eq pageNo}">
                                    <li class="active">
                                        <a href="/admin/adopt/complete?pageNo=${pageNo}">${pageNo}</a>
                                    </li>
                                </c:if>
                                <c:if test="${pageForm.currentPage ne pageNo}">
                                    <li>

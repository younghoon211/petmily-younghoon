                        ...
                        <c:forEach var="wait" items="${adopt.content}">
                            ...
                            <th>
                                <button type="button" class="btn btn-primary"
                                        onclick="location.href='/admin/adopt/wait/approve?adNumber=${wait.adNumber}'">
                                    승인
                                </button>
                                &nbsp;
                                <button type="button" class="btn btn-danger"
                                        onclick="location.href='/admin/adopt/wait/refuse?adNumber=${wait.adNumber}'">
                                    거절
                                </button>
                            </th>
                            </tbody>
                    ...
                    <ul>
                        <li>
                            <c:if test="${adopt.startPage > 5}">
                                <a href="/admin/adopt/wait?pageNo=${adopt.startPage - 5}">&lt;</a>
                            </c:if>
                        </li>
                        <li>
                        ...
                        <li class="active">
                            <a href="/admin/adopt/wait?pageNo=${pbNum}">${pbNum}</a>
                        </li>
                        </c:if>
                        <c:if test="${adopt.currentPage != pbNum}">
                            <li>

	...
	<div class="container">
		<div class="row no-gutters slider-text align-items-end">
			<div class="col-md-9 ftco-animate pb-5">
				<h1 class="mb-0 bread">임보 거절 리스트</h1>
			</div>
		</div>
	</div>
</section>
					...
					<ul>
						<li>
							<c:if test="${temp.startPage > 5}">
								<a href="/admin/adopt_temp/refuse/temp_pet?pageNo=${temp.startPage - 5}">&lt;</a>
							</c:if>
						</li>
						<li>
						...
						<li class="active">
							<a href="/admin/adopt_temp/refuse/temp_pet?pageNo=${pbNum}">${pbNum}</a>
						</li>
						</c:if>
						<c:if test="${temp.currentPage != pbNum}">
							<li>

            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-end">
                    <div class="col-md-9 ftco-animate pb-5">
                        <h1 class="mb-0 bread">입양/임보 거절 리스트</h1>
                    </div>
                </div>
            </div>
    </section>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body p-4">
                            <h3 class="heading">입양 거절 리스트</h3>
                            <a
                                    href="/admin/adopt_temp/refuse/adopt"
                ...
                <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body p-4">
                            <h3 class="heading">임보 거절 리스트</h3>
                            <a
                                    href="/admin/adopt_temp/refuse/temp_pet"
                                    class="btn-custom d-flex align-items-center justify-content-center"><span
                                    class="fa fa-chevron-right"></span><i class="sr-only">Read
                                more</i></a>
                        </div>

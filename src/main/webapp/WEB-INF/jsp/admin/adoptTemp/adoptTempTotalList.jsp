    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs mb-2"></p>
                <h1 class="mb-0 bread">입양/임보 관리</h1>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="container">
                        <div class="row mb-5 pb-5">
                            <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                                <div class="d-block services text-center">
                                    <div class="media-body p-4">
                                        <h3 class="heading">입양/임보 승인 관리</h3>
                                        <a href="/admin/adopt_temp/wait"
                            ...
                            <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                                <div class="d-block services text-center">
                                    <div class="media-body p-4">
                                        <h3 class="heading">입양/임보 완료 리스트</h3>
                                        <a href="/admin/adopt_temp/complete"
                                           class="btn-custom d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                                <div class="d-block services text-center">
                                    <div class="media-body p-4">
                                        <h3 class="heading">입양/임보 거절 리스트</h3>
                                        <a href="/admin/adopt_temp/refuse"
                                           class="btn-custom d-flex align-items-center justify-content-center">
                                            <span class="fa fa-chevron-right"></span>
                                            <i class="sr-only">Read more</i></a>
                                    </div>

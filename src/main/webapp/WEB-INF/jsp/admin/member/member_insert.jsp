    ...
    <div class="container">
        ...
        <div class="row no-gutters" style="margin: 0 auto; width:50%">
            <div class="contact-wrap w-100 p-md-5 p-4">
                <form action="/admin/member/insert" method="post" class="contactForm" id="form">
                    <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        function validId() {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/member/insert/idValid',
                data: {id: id},
        ...
        function validEmail() {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/member/insert/emailValid',
                data: {email: email},
                success: function (result) {
        ...
        function validPhone() {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/member/insert/phoneValid',
                data: {phone: phone},
                success: function (result) {

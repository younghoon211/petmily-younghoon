...
<div class="row no-gutters">
    <div class="col-md-7">
        <div class="contact-wrap w-100 p-md-5 p-4">
            ...
            <form action="/admin/member/modify" method="POST" id="contactForm"
                  name="contactForm" class="contactForm">
                <div class="row">

                    <input type="hidden" name="mNumber" value="${member.getMNumber()}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="label" for="grade">회원 등급</label> <input type="text"
                                                                                  ...
                                                                                  id="grade"
                                                                                  value="${member.grade}*" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="submit" value="수정" onclick="alert('수정 완료')"

                    ...
                    <div class="modal-body">
                        ...
                        <div class="row justify-content-start">
                            <div class="form-group col-md-6 col-lg-6">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="이름을 입력해주세요" autofocus="" required="required"/>
                            </div>
                            <div class="form-group col-md-6 col-lg-6">
                        ...
                        <div class="form-group col-md-6 col-lg-6">
                            ...
                            <div id="speciesInput" class="form-check form-check-inline">
                                ...
                                <input type="radio" class="form-check-input" name="species" id="speciesInput3" value="기타" checked="checked"/>기타<span>&emsp;</span>
                            </div>
                        </div>
                        <div class="form-group col-md-6 col-lg-6">
                        ...
                        <div class="form-group col-md-6 col-lg-6">
                            ...
                            <div id="animalState" class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" name="animalState" id="animalState1" value="입양"/>입양<span>&emsp;</span>
                                <input type="radio" class="form-check-input" name="animalState" id="animalState2" value="임보"/>임시보호<span>&emsp;</span>
                                <input type="radio" class="form-check-input" name="animalState" id="animalState3" value="보호"/>보호소<span>&emsp;</span>
                                <input type="radio" class="form-check-input" name="animalState" id="animalState4" value="-" checked="checked"/>-
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-start">
                            <div class="form-group col-md-6 col-lg-4">
                                ...
                                <input type="text" class="form-control" name="kind" id="kindInput" placeholder="모르는 경우 '모름' 작성" required="required"/>
                            </div>
                            <div class="form-group col-md-6 col-lg-4">
                                <label for="ageInput">나이:</label>
                                <input type="text" class="form-control" name="age" id="ageInput" placeholder="숫자만 입력해주세요" required="required"/>
                            </div>
                            <div class="form-group col-md-6 col-lg-4">
                                <label for="weightInput">몸무게:</label>
                                <input type="text" class="form-control" name="weight" id="weightInput" placeholder="숫자만 입력해주세요" required="required"/>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between">
                            <div class="form-group col-md-6 col-lg-4">
                                ...
                                <input type="text" class="form-control" name="location" id="locationInput" placeholder="모르는 경우 '모름' 작성" required="required"/>
                            </div>
                            <div class="form-group col-md-6 col-lg-4">
                            ...
                            <div class="form-group col-md-6 col-lg-4">
                                ...
                                <input type="text" class="form-control" name="uniqueness" id="uniquenessInput" placeholder="특이사항" required="required"/>
                            </div>
                        </div>

                        <hr color="#eee" width="100%">

                        <textarea rows="5" class="form-control" name="description" id="description" placeholder=" 소개글" required="required"></textarea>

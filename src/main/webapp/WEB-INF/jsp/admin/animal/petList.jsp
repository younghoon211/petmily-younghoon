        ...
        <div class="inner-main-body p-2 p-sm-3 collapse forum-content show">
                    ...
                    <table class="table table-hover bg-white">
                        ...
                        <c:forEach var="pet" items="${petPage.content}">
                            ...
                            <tr>
                                ...
                                <td class="col-md-1">
                                    <button type="button" data-cpnumber="${pet.cpNumber}" data-userid="${pet.userId}"
                                            data-name="${pet.name}" data-species="${pet.species}"
                                            data-kind="${pet.kind}" data-gender="${pet.gender}"
                                            class="updateModalBtn btn btn-primary" data-toggle="modal"
                                            data-target="#updatePetModal">수정
                                    </button>
                                </td>
                                <td class="col-md-1"><a class="btn btn-danger text-white"
                                                        onclick="let b = confirm('삭제하시겠습니까?'); if(b){ location.href='/admin/animal/pet/delete/${pet.cpNumber}'}">삭제</a>
                                </td>
                            </tr>
            ...
            <span class="modal-footer">
				<button type="button" class="btn btn-primary" data-toggle="modal"
                        data-target="#savePetModal">반려동물 등록</button>
			</span>
...
<!-- 게시판 List 끝 -->
<%--modal--%>
<div class="modal fade" id="savePetModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
...
<div class="modal fade" id="updatePetModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">

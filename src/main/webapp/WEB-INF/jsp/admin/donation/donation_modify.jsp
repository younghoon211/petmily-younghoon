...
<div class="container survey">
    ...
    <form method="post" action="/admin/donation/modify?dNumber=${modifyForm.getDNumber()}">
        ...
        <select class="form-control" name="abNumber" required>
            <c:forEach var="ab" items="${abandonedAnimals}">
                <option value="${ab.abNumber}"
                        <c:if test="${modifyForm.abNumber eq ab.abNumber}">selected</c:if>
        ...
        <select class="form-control" name="mNumber" required>
            <c:forEach var="m" items="${members}">
                <option value="${m.getMNumber()}"
                        <c:if test="${modifyForm.getMNumber() eq m.getMNumber()}">selected</c:if>
                >${m.name} (${m.getMNumber()})
                </option>
            </c:forEach>
        </select><br>
        ...
        <div class="form-row">
            ...
            <div class="col">
                ...
                <input name="accountHolder"
                       type="text" class="form-control" value="${modifyForm.accountHolder}"
                       required>
            </div>

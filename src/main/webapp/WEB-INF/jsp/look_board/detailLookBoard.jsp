        ...
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs mb-2">
                    <span class="mr-2"><span>Look Animal Board - Detail<i class="ion-ios-arrow-forward"></i></span></span>
                </p>
            ...
            <div class="row d-flex no-gutters">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 services-2 w-100 d-flex">
                        ...
                        <div class="text pl-3">
                            <h4>상태</h4>
                            <p>${lookIn.animalState}</p>
                        </div>
                    </div>
                </div>
                <div>
                    <p style="font-size:x-large">${lookIn.content}</p>
                </div>
                <div>
                    <c:if test="${authUser.getMNumber() == lookIn.getMNumber()}">
                        <button type="button" class="btn btn-primary"
                                onclick="location.href='/lookBoard/auth/modify?laNumber=${lookIn.laNumber}'">수정
                        </button>
                        <button type="button" class="btn btn-primary"
                                onclick="location.href='/lookBoard/auth/delete?laNumber=${lookIn.laNumber}'">삭제
                        </button>
                    </c:if>
                    <button type="button" class="btn btn-primary"

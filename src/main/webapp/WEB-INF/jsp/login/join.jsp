                        ...
                        <div>
                            ...
                            <spring:hasBindErrors name="joinForm">
                                <c:if test="${errors.hasFieldErrors('id')}">
                                    <span class="field-error"><form:errors path="joinForm.id"/></span>
                                </c:if>
                            </spring:hasBindErrors>
                        </div>
                        <div class="password">
                            ...
                            <spring:hasBindErrors name="joinForm">
                                <c:if test="${errors.hasFieldErrors('pw')}">
                                    <span class="field-error"><form:errors path="joinForm.pw"/></span>
                                </c:if>
                            </spring:hasBindErrors>
                            ...
                            <spring:hasBindErrors name="joinForm">
                                <c:if test="${errors.hasFieldErrors('confirmPw')}">
                                    <span class="field-error"><form:errors path="joinForm.confirmPw"/></span>
                                </c:if>
                            </spring:hasBindErrors>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <spring:hasBindErrors name="joinForm">
                                <c:if test="${errors.hasFieldErrors('gender')}">
                                    <span class="field-error"><form:errors path="joinForm.gender"/></span>
                                </c:if>
                            </spring:hasBindErrors>
                        </div>
                        <div>
                            ...
                            <spring:hasBindErrors name="joinForm">
                                <c:if test="${errors.hasFieldErrors('email')}">
                                    <span class="field-error"><form:errors path="joinForm.email"/></span>
                                </c:if>
                            </spring:hasBindErrors>
                        </div>
                        <div>
                            ...
                            <spring:hasBindErrors name="joinForm">
                                <c:if test="${errors.hasFieldErrors('phone')}">
                                    <span class="field-error"><form:errors path="joinForm.phone"/></span>
                                </c:if>
                            </spring:hasBindErrors>
                        </div>
                        <div class="login">

                                ...
                                <ul>
                                    <li>
                                        <c:if test="${myPost.startPage > 5}">
                                            <a href="${pageContext.request.contextPath}/member/auth/myPost/입양후기/list?pageNo=${myPost.startPage - 5}">&lt;</a>
                                        </c:if>
                                    </li>
                                    <c:forEach var="pNo" begin="${myPost.startPage}" end="${myPost.endPage}">
                                        <c:if test="${myPost.currentPage == pNo}">
                                            <li class="active">
                                                <a href="${pageContext.request.contextPath}/member/auth/myPost/입양후기?pageNo=${pNo}">${pNo}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${myPost.currentPage != pNo}">
                                            <li>
                                    ...
                                    <li>
                                        <c:if test="${myPost.endPage < myPost.totalPages}">
                                            <a href="${pageContext.request.contextPath}/member/auth/myPost/입양후기?pageNo=${myPost.startPage + 5}">&gt;</a>
                                        </c:if>
                                    </li>
                                </ul>
                            </div>

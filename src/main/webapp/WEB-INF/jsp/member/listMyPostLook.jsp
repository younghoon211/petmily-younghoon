...
<section class="ftco-section bg-light">
    <div class="container">
        ...
        <div style="text-align: center">
            ...
            <c:if test="${type == 'board' && param.kindOfBoard == '자유'}">
                   checked
            </c:if>>
            ...
            <c:if test="${type == 'board' && param.kindOfBoard == '문의'}">
                   checked
            </c:if>>
                            ...
                            <div class="col-md-4 ftco-animate" id="d-flex-out">
                                <div class="blog-entry align-self-stretch" id="d-flex-in">
                                    ...
                                    <div class="text p-4">
                                        ...
                                        <h3 class="heading">
                                            <a href="${pageContext.request.contextPath}/lookBoard/detail?laNumber=${lookBoard.laNumber}">${lookBoard.title}</a>
                                        </h3>
                                        <div class="meta mb-2">
                                ...
                                <ul>
                                    <li>
                                        <c:if test="${myPost.startPage > 5}">
                                            <a href="${pageContext.request.contextPath}/member/auth/myPost/look?pageNo=${myPost.startPage - 5}">&lt;</a>
                                        </c:if>
                                    </li>
                                    <c:forEach var="pNo" begin="${myPost.startPage}" end="${myPost.endPage}">
                                        <c:if test="${myPost.currentPage == pNo}">
                                            <li class="active">
                                                <a href="${pageContext.request.contextPath}/member/auth/myPost/look?pageNo=${pNo}">${pNo}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${myPost.currentPage != pNo}">
                                            <li>

                                ...
                                <ul>
                                    <li>
                                        <c:if test="${myPost.startPage > 5}">
                                            <a href="${pageContext.request.contextPath}/member/auth/myPost/find?pageNo=${myPost.startPage - 5}">&lt;</a>
                                        </c:if>
                                    </li>
                                    <c:forEach var="pNo" begin="${myPost.startPage}" end="${myPost.endPage}">
                                        <c:if test="${myPost.currentPage == pNo}">
                                            <li class="active">
                                                <a href="${pageContext.request.contextPath}/member/auth/myPost/find?pageNo=${pNo}">${pNo}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${myPost.currentPage != pNo}">
                                            <li>

    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                ...
                <h1 class="mb-0 bread">매칭된 찾아요 게시글</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-section bg-light">
    <div class="container">
        ...
        <br>
        <p style="text-align: center; color: red">※ 게시글 클릭 시, 해당 글에 매칭된 봤어요 게시글 리스트로 이동됩니다.</p>
                    ...
                    <c:forEach var="findBoard" items="${pageForm.content}">
                        <div class="col-md-4 ftco-animate" id="d-flex-out">
                            <div class="blog-entry align-self-stretch" id="d-flex-in">
                                <a href="<c:out value='/member/auth/findMatching/lookList?faNumber=${findBoard.faNumber}'/>"
                    ...
                    <ul>
                        <li>
                            <c:if test="${pageForm.startPage > 5}">
                                <a href="/member/auth/checkMatching/findList?pageNo=${pageForm.startPage - 5}">&lt;</a>
                            </c:if>
                        </li>
                        <c:forEach var="pNo" begin="${pageForm.startPage}" end="${pageForm.endPage}">
                            <c:if test="${pageForm.currentPage eq pNo}">
                                <li class="active">
                                    <a href="/member/auth/checkMatching/findList?pageNo=${pNo}">${pNo}</a>
                                </li>
                            </c:if>
